# ########################################
# CUSTOM MODIFIED OBJ EXPORTER SCRIPT
# THIS WAS ORIGINALLY HASTLY MADE WHILE I WAS WORKING ON MY GAME JAM GAME
# SO THIS SCRIPT IS HEAVILY UNSTABLE BUT IT KINDA WORKS
# HAVE FUN I GUESS - ZIK @ MMXXII
# ########################################
...
bl_info = {
    "name": "Wavefront OBJ format (custom ZIK version)",
    "author": "Campbell Barton, Bastien Montagne and ZIK",
    "version": (6, 6, 6),
    "blender": (2, 81, 6),
    "location": "File > Import-Export",
    "description": "Import-Export OBJ, Import OBJ mesh, UV's, materials and textures and vertex colour",
    "warning": "",
...
if "bpy" in locals():
    import importlib
    if "export_obj_adv" in locals():
        importlib.reload(export_obj_adv)
...
class ExportOBJAdv(bpy.types.Operator, ExportHelper):
    """Save a Wavefront OBJ File"""

    bl_idname = "export_scene.obj_adv"
    bl_label = 'Export OBJ (advanced)'
    bl_options = {'PRESET'}
    ...
    def execute(self, context):
        ...
        return export_obj_adv.save(context, **keywords)

    def draw(self, context):
        pass


class OBJ_PT_export_include_adv(bpy.types.Panel):
    ...
    def poll(cls, context):
        ...
        # print("OPERATOR IDNAME: " + operator.bl_idname)
        return operator.bl_idname == "EXPORT_SCENE_OT_obj_adv"
...
class OBJ_PT_export_transform_adv(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Transform"
    bl_parent_id = "FILE_PT_operator"
...
class OBJ_PT_export_geometry_adv(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Geometry"
    bl_parent_id = "FILE_PT_operator"
...
def menu_func_export(self, context):
    self.layout.operator(ExportOBJAdv.bl_idname, text="Wavefront advanced(.obj)")


classes = (
    ExportOBJAdv,
    OBJ_PT_export_include_adv,
    OBJ_PT_export_transform_adv,
    OBJ_PT_export_geometry_adv,
)
